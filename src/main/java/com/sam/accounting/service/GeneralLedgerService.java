...
public class GeneralLedgerService implements PropertyChangeListener {
	...
	private void populateFromTransaction() {
		List<com.sam.accounting.model.entities.Transaction> lt = t_repo.findAll();
		Comparator<com.sam.accounting.model.entities.Transaction> comp= new Comparator<com.sam.accounting.model.entities.Transaction>() {
			
			@Override
			public int compare(com.sam.accounting.model.entities.Transaction o1,
					com.sam.accounting.model.entities.Transaction o2) {
		...
		for (com.sam.accounting.model.entities.Transaction transaction : lt) {
			SimpleDateFormat sdf = new SimpleDateFormat("d-MMM-yy");
			String date = "";
