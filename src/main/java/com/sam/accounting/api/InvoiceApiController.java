...
import com.sam.accounting.model.dto.InvoiceCreationRequest;
import com.sam.accounting.model.dto.InvoiceDto;
import com.sam.accounting.model.dto.InvoiceUpdateRequest;
...
import com.sam.accounting.service.AttachmentService;
import com.sam.accounting.service.InvoiceService;
import com.sam.accounting.service.util.DateParser;
import com.sam.accounting.service.util.InvoicePromptFactory;
...
//					"description":"Facture intérimaire pour services professionnels rendus à ce jour relativement à :\nOuverture de compte - 500 $ ;\nProcurations, support fourni pour l'activation des accès - 220 $ ;\nDiverses suivis pour l'obtention des documents - 400 $ ;\nAnalyse de la dette corporative, plusieurs échanges avec l'ARC - 600 $ ;\nÉchanges sur la liquidation et la dissolution - 600 $ ;\nRencontre avec M. Sylvain Fontenelle, ASC, CPA et Amélie Lebuis, CP\nauditrice le 4 juillet 2023 - 200 $;\nMoins facture # 5045 au montant de 1 500$.",
//					   "noFacture":"3739",
//					   "amount":"1 020,00",
//					   "tps":"5854",
//					   "tvq":"145351359",
//					   "date":"2023-10-03",
//					   "recipient":"9321-0474 Québec inc.",
//					   "origine":"Virement Interac, transfert bancaire ou carte de crédit"
				
					String no_facture = result.finalResult.answer.get("noFacture").asText();
					String amount =  result.finalResult.answer.get("amount").asText();
					String recipient =  result.finalResult.answer.get("recipient").asText();
					String date =  result.finalResult.answer.get("date").asText();
					if (null != existing) {
