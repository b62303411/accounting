package com.sam.accounting.inuit.oauth2.client;
...
public class OAuth2PlatformClientFactory {
	...
	String clientId= "ABJwmx6mTgcquckOxObZXZT0tWAa2xRsOB9OLxrRy3IJHwRJLT";
	String clientSecret= "jrxWyemSe2EbOZZjHOz2ZvZ4nvydUHoJwwgUCOJp";
	
	public OAuth2Config getDevConfig() 
	{
