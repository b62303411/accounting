...
public class RefreshTokenController {
	...
	private static final Logger logger = Logger.getLogger(RefreshTokenController.class.getName());
    ...
    public String refreshToken(HttpSession session) {
        ...
        try {
            ...
            logger.log(Level.SEVERE,"OAuthException while calling refreshToken ", ex);
        	...
        	logger.log(Level.SEVERE,"Exception while calling refreshToken ", ex);
